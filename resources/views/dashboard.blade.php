...
<section class = "w-full mx-auto my-12 px-12 flex justify-around" >
...
<a href="{{ route('crearBlogpost') }}" class="ml-4 focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2 me-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Crear Blogpost</a>
</section>
