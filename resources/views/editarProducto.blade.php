<?php
    ...
    ?>
    <x-layout>
        <x-slot:title>Editar Blogpost</x-slot:title>
        <section>
        <h1 class="max-w-2xl mb-12 pt-12 text-4xl text-lightgreen font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-whitel">Editar Blogpost</h1>
        ...
        <form action="{{ route('cargaEditarProducto', ['id' => $producto->producto_id]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <div class="mb-6">
                ...
                <textarea
                    ...
                    required
                >{{ old('descripcion', $producto->descripcion) }}</textarea> @error('descripcion')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
             <div class="mb-6">
            ...
            <div class="mb-6">
            <img src="{{ asset($producto->imagen) }}" alt="Imagen del producto" class="mb-4 w-48 h-48 object-cover">
