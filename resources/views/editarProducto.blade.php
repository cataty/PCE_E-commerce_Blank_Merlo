<?php
    ...
    <x-layout>
        ...
        <section>
        <h1 class="max-w-2xl mb-12 pt-12 text-4xl text-lightgreen font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-whitel">Editar Producto</h1>
        ...
        <div>
            ...
            <div class="mb-6">
            <img src="{{ asset('storage/' . $producto['imagen']) }}" alt="Imagen del producto" class="mb-4 w-48 h-48 object-cover">
