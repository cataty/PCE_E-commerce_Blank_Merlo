<?php
    ...
    <x-layout>
        ...
        <section>
        <h1 class="max-w-2xl mb-12 pt-12 text-4xl text-lightgreen font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-whitel">Crear Producto</h1>

        @if ($errors->any())
            <div class="w-screen bg-red-100 border-l-4 border-red-500 text-red-700 p-4 mb-4" role="alert">
                <p>Tu formulario contiene errores, por favor revisa</p>                <img id="preview" src="#" alt="Vista previa" class="mb-4 w-48 h-48 object-cover" style="display:none;">

            </div>
        @endif

        <form action="{{ route('cargaDatosProducto') }}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            <div class="mb-6">
                ...
                <input
                    ...
                    {{-- El valor de un input text no se puede mantener por seguridad --}}
                    value="" >
                @error('nombre')
            ...
            <div class="mb-6">
                <label for="descripcion" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Contenido:</label>
                <textarea
                    id="descripcion"
                    name="descripcion"
                    rows="7"
                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('descripcion') border-red-500 @enderror"
                    required
                    placeholder="Descripción del producto"
                ></textarea> @error('descripcion')
                    <div class="text-red-500 text-sm mt-1">{{ $message }}</div>
                @enderror
            </div>
             <div class="mb-6">
                ...
                <input
                    ...
                    id="precio"
                    name="precio"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 @error('precio') border-red-500 @enderror"
                    value="0"
                    required 
                    step="100">
                @error('precio')
            ...
            <div class="mb-6">
            <img id="preview" src="#" alt="Vista previa" class="mb-4 w-48 h-48 object-cover" style="display:none;">
            <script>
